...
// default is ripa mainnet
var networkVersion = 0x37;
...
function getBytes(transaction) {
	...
	bb.writeByte(transaction.network); // ripa = 0x37, devnet = 0x4B
...
function getKeys(secret, network) {
	var ecpair = ECPair.fromSeed(secret, network || networks.ripa);
